...
\begin{frame}[fragile]{Module cảm biến đeo I: Luồng làm việc}
    \begin{columns}[t]
        \begin{column}{0.7\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.95\textwidth,height=0.7\textheight,keepaspectratio]{images/module1_time_flow.pdf}
            \end{figure}
        \end{column}
...
\begin{frame}[fragile]{Module cảm biến đeo I: Sơ đồ khối phần mềm}
    \begin{figure}
        \centering
