...
\end{frame}
\begin{frame}
\frametitle{Cấu trúc Phân Cấp}
\begin{itemize}
    \item \textbf{Primitives (Cấp 0)}: Các thành phần cơ bản nhất (điểm, đường).
    \item \textbf{Parts (Cấp 1)}: Tập hợp các Primitives tạo thành các bộ phận.
    \item \textbf{Object (Cấp 2)}: Tập hợp các Parts tạo thành đối tượng hoàn chỉnh.
\end{itemize}
\end{frame}
